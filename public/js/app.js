class App {
  initComponents() {
    ...
    let n = document.getElementById("liveAlertPlaceholder");
  ...
  initTopbarScroll() {
    ...
    if (a) {
      ...
      window.addEventListener("scroll", function () {
        ...
        30 <= e && !t
          ? (a.classList.add("topbar-active"), (t = !0))
          : e < 30 && t && (a.classList.remove("topbar-active"), (t = !1));
      });
    } else console.warn('⚠️ Element with ID "header" not found.');
  }
  init() {
    this.initComponents(),
...
class ThemeCustomizer {
  ...
  initSwitchListener() {
    ...
    document.querySelectorAll(".sidenav-toggle-button").forEach(function (e) {
    ...
    e &&
      ...
      document.querySelectorAll(".button-sm-hover").forEach(function (e) {
        e.addEventListener("click", function () {
          var e = a.config.sidenav.size;
          "sm-hover-active" === a.html.getAttribute("data-sidenav-size", e)
            ? a.changeLeftbarSize("sm-hover", !0)
            : a.changeLeftbarSize("sm-hover-active", !0);
        });
      });
  }
  showBackdrop() {
  ...
  _adjustLayout() {
    ...
    window.innerWidth <= 1140
      ? (e.changeLeftbarSize("full", !1), e.changeLayoutMode("default", !1))
  ...
  setSwitchFromConfig() {
    ...
    o &&
      ...
      (a = document.querySelector(
        "input[type=radio][name=data-layout-mode][value=" + o.layout.mode + "]"
      )),
      ...
      (i = document.querySelector(
        "input[type=radio][name=data-menu-color][value=" + o.menu.color + "]"
      )),
...
let customJS = () => {
  ...
  document.addEventListener("mousemove", function (t) {
    ...
    (() => {
      var e = document.querySelectorAll("[data-toggler]");
      let n = (e) => {
